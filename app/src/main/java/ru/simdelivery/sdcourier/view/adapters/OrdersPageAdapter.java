...
public class OrdersPageAdapter extends RecyclerView.Adapter<OrdersPageAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            status = itemView.findViewById(R.id.order_page_pick_up_status_view);
            city = itemView.findViewById(R.id.order_page_pick_up_city_view);
            street = itemView.findViewById(R.id.order_page_pick_up_street_view);
            building = itemView.findViewById(R.id.order_page_pick_up_house_view);
            apartmentNum = itemView.findViewById(R.id.order_page_pick_up_apartment_view);
            time = itemView.findViewById(R.id.order_page_pick_up_time_data_view);
            commentBtn = itemView.findViewById(R.id.order_page_pick_up_commentary_button);
            mapBtn = itemView.findViewById(R.id.order_page_pick_up_map_button);
        }
    }
